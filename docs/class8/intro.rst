...
After following the invitation email's **Update Password** link, proceed to the first step below. 
...
|                                                                                              |
|    **namespace** which you will by defaulted to (in terms of GUI navigation) for all tasks   |
|                                                                                              |
