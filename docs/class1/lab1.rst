...
workspace. If for some reason you are not in **Web App & API Protection**, use **Select Workspace**
in the left-hand navigation, and choose **Web App & API Protection** as shown in the
...
14. Select the **<your-namespace>/<your-namespace>-pool** from the **Origin Pool**  dropdown.
...
1. Following **Task 2**, you should have the **Web App & API Protection** navigation panel on the left of your
   console. If for some reason you do not see the **Web App & API Protection** navigation panel, use the
   **Select Workspace** dropdown at the top left, and click **Web App & API Protection** as shown in the
   *Introduction section, Task 2, Step 9*.
