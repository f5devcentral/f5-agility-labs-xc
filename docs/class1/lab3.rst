 ...
 *Variable*                        *Value*
 ================================= ======
 Name                              **<your-namespace>-private-pool**
 ================================= ======
...
5. Select the recently created **<your-namespace>-private-pool** under **Origin Pool** and then click **Apply**
...
The FQDN we used in our example is http://<your-namespace>.aws.lab.f5demos.com/.
