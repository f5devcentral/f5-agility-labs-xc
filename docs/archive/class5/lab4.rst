...
if you are the first to mitigate the attack (for in-person AppWorld live event only).
...
|                                                                                              |
|     **Hint** Only one HTTP method is permitted in this new endpoint rule, and the            |
|     **Endpoint Label** parameter must be correctly configured...                             |
+----------------------------------------------------------------------------------------------+
...
|    *scraper-sec* endpoint name then **Edit**. Make sure to **Apply** and **Save** all changes|
+----------------------------------------------------------------------------------------------+
| |lab4-task3-01|                                                                              |
|                                                                                              |
| |lab4-task3-02|                                                                              |
