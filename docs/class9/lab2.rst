...
+-------------------------------------------------------------------------------------------------------------------------------------------------+
| 2. If you are not already in the **Web App & API Protection** workspace, from the top navigation bar, select the **Web App & API Protection**   |
|                                                                                                                                                 |
|    workspace.                                                                                                                                   |
+-------------------------------------------------------------------------------------------------------------------------------------------------+
| 3. Navigate to **Manage** > **Load Balancers** and select **HTTP Load Balancers**.                                                              |
+-------------------------------------------------------------------------------------------------------------------------------------------------+
| 4. In the HTTP Load Balancers list, locate your load balancer and click the ellipsis (three dots) under the **Actions** column. Select          |
|                                                                                                                                                 |
...
| 3. Navigate to **Manage** > **Load Balancers** and select **HTTP Load Balancers**.                                                               |
+--------------------------------------------------------------------------------------------------------------------------------------------------+
| 4. In the HTTP Load Balancers list, locate your load balancer and click the ellipsis (three dots) under the **Actions** column. Select **Manage**|
|                                                                                                                                                  |
|     **Configuration**.                                                                                                                           |
+--------------------------------------------------------------------------------------------------------------------------------------------------+
| 5. In the Load Balancer configuration page, scroll to the **Route Configuration** section. Click **Add Route Policy**.                           |
