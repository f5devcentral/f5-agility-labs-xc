...
#. You will see "api-lab-def" file. This step has been preconfigured for your convenience, referencing the precreated OpenAPI file (api-lab-swagger) in the API definition file (api-lab-def).
